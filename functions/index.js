...
exports.reminderSweep = onSchedule(
  ...
  async () => {
    ...
    for (const l of leads) {
      ...
      const message = `Hi ${l.source_name || "there"}, this is Neha from Ashiesh Sharma's team at B P T P. I wanted to remind you about your meeting with your customer ${client_ref} for ${project || "the project"} on ${date}. Wishing us a successful and long-term association together, along with this deal.`;
